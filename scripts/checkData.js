...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var roastRecords, tastingRecords, shopVisits, espressoRecords;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.roastRecord.findMany()];
                case 1:
                    roastRecords = _a.sent();
                    return [4 /*yield*/, prisma.tastingRecord.findMany()];
                case 2:
                    tastingRecords = _a.sent();
                    return [4 /*yield*/, prisma.shopVisit.findMany()];
                case 3:
                    shopVisits = _a.sent();
                    return [4 /*yield*/, prisma.espressoRecord.findMany()];
                case 4:
                    espressoRecords = _a.sent();
